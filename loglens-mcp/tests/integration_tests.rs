// Integration tests for LogLens MCP server
...
async fn test_list_projects_empty() {
    ...
    use loglens_mcp::tools::projects::list_projects;
...
async fn test_get_project_not_found() {
    ...
    // Test tool function directly
    use loglens_mcp::tools::projects::get_project;
...
async fn test_server_config() {
    ...
    assert_eq!(server.config().server_name, "loglens-mcp");
}
...
async fn test_database_path_resolution() {
    ...
    std::env::set_var("LOGLENS_DATABASE_PATH", "/custom/test.db");
...
async fn test_query_analyses_with_filters() {
    ...
    use loglens_core::project::queries::query_analyses;
...
async fn test_get_analysis_by_id() {
    ...
    use loglens_core::project::queries::get_analysis_by_id;
