...
class WasmService {
  private wasmModule: SynapseWasm | null = null;
  ...
  private async initialize(): Promise<void> {
    try {
      console.log('[WASM] Loading Synapse WASM module...');

      // Import the WASM module generated by wasm-pack
      const wasmModule = await import('../../../../synapse-wasm/pkg/synapse_wasm');
      ...
      this.wasmModule = wasmModule as SynapseWasm;
      console.log('[WASM] Synapse WASM module loaded successfully');
    } catch (error) {
  ...
  private async ensureInitialized(): Promise<SynapseWasm | null> {
    if (!this.initPromise) {
      this.initPromise = this.initialize();
    }
