// TOML configuration for LogLens projects

use anyhow::Result;
use serde::{Deserialize, Serialize};
use std::path::Path;

/// Project configuration stored in .loglens/config.toml
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ProjectConfig {
    pub project: ProjectSection,
    pub loglens: LogLensSection,
    #[serde(default)]
    pub mcp: McpSection,
}
...
mod tests {
    ...
    fn test_config_creation() {
        ...
        assert_eq!(config.loglens.auto_analyze, true);
        assert_eq!(config.loglens.default_provider, "openrouter");
...
"#;
        ...
        assert_eq!(config.loglens.auto_analyze, false);
        assert_eq!(config.loglens.default_provider, "claude");
        assert_eq!(config.loglens.default_level, "WARN");
    ...
    fn test_config_roundtrip() {
        ...
        assert_eq!(original.loglens.auto_analyze, parsed.loglens.auto_analyze);
    }
