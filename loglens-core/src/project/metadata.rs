// JSON metadata for LogLens projects
...
/// Project metadata stored in .loglens/metadata.json
...
impl ProjectMetadata {
    ...
    pub fn new(project_name: String, project_type: String, root_path: String) -> Self {
        ...
        Self {
            ...
            project_type,
            root_path,
            loglens_version: env!("CARGO_PKG_VERSION").to_string(),
            created_at: now,
            last_updated: now,
...
mod tests {
    ...
    fn test_metadata_serialization() {
        ...
        assert!(json.contains("loglens_version"));
    }
